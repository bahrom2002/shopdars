...
if (isset($_POST['newpassword']) && isset($_POST['oldpassword']) && isset($_SESSION['user']['id'])){
    ...
    if ($user['password'] == $oldpassword){
        if ($user['password'] !== $newpassword) {
            ...
            $error = 'Iltimos yangi parol kiriting';
        }
    }else{
        $error = "Eski parol notug'ri, iltimos qayta kiriting";
    }
}
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="row mb-4">
                                ...
                                <div class="col-sm-9">
                                    <input type="password" class="form-control" name="oldpassword" id="resetLabel" placeholder="Eski parolni kirting">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="card-body">
                            <div class="row mb-4">
                                ...
                                <div class="col-sm-9">
                                    <input type="password" class="form-control" name="newpassword" id="resetLabel" placeholder="Yangi parolni kirting">
                                </div>
                            </div>
                            <div class="col-sm-5">
