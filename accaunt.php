    ...
    <div class="container">
        <nav class="js-mega-menu navbar-nav-wrap">
            ...
            <a class="navbar-brand" href="index.php" aria-label="Front">
                <img class="navbar-brand-logo" src="index.php" alt="Logo">
            </a>
            <!-- End Default Logo -->
          ...
          <span class="navbar-toggler-default">
            ...
            <div class="collapse navbar-collapse" id="navbarNavDropdown">
                <ul class="navbar-nav">
                    ...
                    <!-- Account -->
                    <li class="hs-has-sub-menu nav-item">
                        <a id="accountMegaMenu" class="hs-mega-menu-invoker nav-link dropdown-toggle active" href="#" role="button" aria-expanded="false">Account</a>
                                    ...
                                    <div class="col-sm-9">
                                        ...
                                        <div class="tom-select-custom mb-3">
                                            <select class="js-select form-select" id="locationLabel">
                                                ...
                                                <option value="CF" data-option-template='<span class="d-flex align-items-center"><img class="avatar avatar-xss avatar-circle shape-3.svg2" src="./assets/vendor/flag-icon-css/flags/1x1/cf.svg" alt="Central African Republic Flag" /><span class="text-truncate">Central African Republic</span></span>'>Central African Republic</option>
                                    ...
                                    <div class="col-sm-9">
                                        ...
                                        <div class="tom-select-custom">
                                            <select class="js-select form-select">
                                                <option value="privacy1" data-option-template='<div class="d-flex align-items-start"><div class="flex-shrink-0"><span class="svg-icon svg-icon-xs text-muted mt-0"><svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
...
</span></div><div class="flex-grow-1 ms-2"><span class="d-block fw-semi-bold">Anyone</span><span class="tom-select-custom-hide small">Visible to anyone who can view your content. Accessible by installed apps.</span></div></div>'>Anyone</option>
                                                <option value="privacy2" data-option-template='<div class="d-flex align-items-start"><div class="flex-shrink-0"><span class="svg-icon svg-icon-xs text-muted mt-0"><svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
...
</span></div><div class="flex-grow-1 ms-2"><span class="d-block fw-semi-bold">Only you</span><span class="tom-select-custom-hide small">Only visible to you.</span></div></div>'>Only you</option>
                                            </select>
                                        </div>
                                        <!-- End Select -->
                                    </div>
